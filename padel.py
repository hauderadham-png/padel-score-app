...
# 1. El link b'tariqa jdida bech Google ma i'ghaltnech fil score
# N'badel el link men 'pub?output=csv' l' 'export?format=csv'
...
def load_data():
    # El faza hedhi tkhalli Google i'jiblek el jdid fil sanyya
    t = int(time.time())
